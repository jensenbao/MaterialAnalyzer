...
namespace MaterialAnalyzer
{
    namespace
    {
        FString GetExpressionNodeId(const UMaterialExpression* Expression)
        {
            if (!Expression)
            {
                return TEXT("");
        ...
        TArray<TSharedPtr<FJsonValue>> BuildNodes(UMaterial* Material, TMap<const UMaterialExpression*, FString>& OutIdMap)
        {
        ...
        TArray<TSharedPtr<FJsonValue>> BuildEdges(UMaterial* Material, const TMap<const UMaterialExpression*, FString>& IdMap)
        {
        ...
        TArray<TSharedPtr<FJsonValue>> BuildPropertyBindings(UMaterial* Material, const TMap<const UMaterialExpression*, FString>& IdMap)
        {
        ...
        TArray<TSharedPtr<FJsonValue>> BuildComments(UMaterial* Material)
        {
    ...
    TSharedRef<FJsonObject> MakeError(const FString& Message, const FString& ErrorType)
    {
    ...
    void AddMaterialProperties(UMaterialInterface* MaterialInterface, const TSharedRef<FJsonObject>& Root)
    {
        ...
        if (BaseMaterial)
        {
            ...
            MaterialJson->SetStringField(TEXT("shading_model"), GetShadingModelFieldString(BaseMaterial->GetShadingModels()));
